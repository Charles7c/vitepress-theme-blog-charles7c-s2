...
<!--      <CommentItem />-->
    ...
    <template #doc-footer-before><PostMetaTags /></template>
...
import PostMetaTags from '../components/PostMetaTags.vue';
import SponsorsAside from '../components/sponsor/SponsorsAside.vue';
