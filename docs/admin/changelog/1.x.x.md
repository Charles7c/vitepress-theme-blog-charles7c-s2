...
|:-------------------------------------------------------------------|:-----------|:-----------|:-----------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------| :------ |------------|-------|
| [1.3.x](https://github.com/continew-org/continew-admin/tree/1.3.x) | 2023-11-04 | -          | [v1.3.1](https://github.com/continew-org/continew-admin/releases/tag/v1.3.1) | {{ Math.ceil(Math.abs(new Date('2023-11-04').getTime() - new Date('2023-09-24').getTime()) / (1000 * 3600 * 24)) }} 天 | 8   |            |       |
| 1.2.x                                                              | 2023-09-24 | 2023-09-24 | [v1.2.0](https://github.com/continew-org/continew-admin/releases/tag/v1.2.0) | {{ Math.ceil(Math.abs(new Date('2023-09-24').getTime() - new Date('2023-09-01').getTime()) / (1000 * 3600 * 24)) }} 天 | 8  |            |       |
| 1.1.x                                                              | 2023-09-01 | 2023-09-24 | [v1.1.2](https://github.com/continew-org/continew-admin/releases/tag/v1.1.2) | {{ Math.ceil(Math.abs(new Date('2023-09-01').getTime() - new Date('2023-03-26').getTime()) / (1000 * 3600 * 24)) }} 天 | 8   |            |       |
| 1.0.x                                                              | 2023-03-26 | 2023-08-17 | [v1.0.1](https://github.com/continew-org/continew-admin/releases/tag/v1.0.1) |                                                                                                                       | 8   |            |       |
